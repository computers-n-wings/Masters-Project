function plots(tout,X,tref,ref)
    ...
    hold on;
    plot(tref(1:60), (180/pi)*ref(1:60, 1), 'LineWidth',1.5);
    hold on;
    ...
    hold on;
    plot(tref(1:60), (180/pi)*ref(1:60, 2), 'LineWidth',1.5);
    hold on;
    ...
    hold on;
    plot(tref(1:60), (180/pi)*ref(1:60, 3), 'LineWidth',1.5);
    ...
    hold on;
    plot(tref(1:60), (180/pi)*ref(1:60, 4), 'LineWidth',1.5);
    legend({'Generated', 'Reference'}, 'Location', 'northwest', 'FontSize', 11);
    ...
    hold on;
    plot(tref(1:60), (180/pi)*ref(1:60, 5), 'LineWidth',1.5);
    legend({'Generated', 'Reference'}, 'Location', 'northwest', 'FontSize', 11);
    ...
    hold on;
    plot(tref(1:60), (180/pi)*ref(1:60, 6), 'LineWidth',1.5);
    legend({'Generated', 'Reference'}, 'Location', 'northwest', 'FontSize', 11);
