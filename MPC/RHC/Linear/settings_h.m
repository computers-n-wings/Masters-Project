...
options.ipopt.tol=1e-5;                        % Desired convergence tolerance (relative). The default value is  1e-8. 
...
options.fmincon=optimset('GradObj','on','GradConstr','on'); 
...
% options.nsegment=3; 
% options.pdegree=10; 
% options.npsegment=[2,2,2];
% options.tau_segment=[-1,0.33,2/3*2-1,1];
